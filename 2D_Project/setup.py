...
resources = "animation_sheet.png bgm.mp3 ConsolaMalgun.ttf \
            credit.png dung.png dung2.png football.mp3 \
            grass.png hero.png over.wav pickup.wav \
            run_animation.png \
            step.wav title.png".split()
